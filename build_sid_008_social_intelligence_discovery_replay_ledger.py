...
LEDGER_FILE = MODULE_DIR / "social_intelligence_discovery_replay_ledger.py"
TEST_FILE = ROOT / "test_sid_008_social_intelligence_discovery_replay_ledger.py"
...
if "SocialIntelligenceDiscoveryReplayLedger" not in existing:
    INIT_FILE.write_text(existing.rstrip() + "\n" + INIT_EXPORT.lstrip(), encoding="utf-8")

print("========================================")
print(" SID-008 INSTALLER")
print(" Social Intelligence Discovery Replay Ledger")
print("========================================")
print(f"[OK] Wrote {LEDGER_FILE}")
print(f"[OK] Wrote {TEST_FILE}")
print(f"[OK] Updated {INIT_FILE}")
print()
print("[DONE] SID-008 installed")
print()
print("Run:")
print("py test_sid_008_social_intelligence_discovery_replay_ledger.py")