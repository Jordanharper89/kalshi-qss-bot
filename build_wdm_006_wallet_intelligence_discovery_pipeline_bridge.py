...
BRIDGE_FILE = MODULE_DIR / "wallet_intelligence_discovery_pipeline_bridge.py"
TEST_FILE = ROOT / "test_wdm_006_wallet_intelligence_discovery_pipeline_bridge.py"
...
TEST_CODE = r'''from qseries_v2.oracle_intelligence.wallet_intelligence_discovery_model.wallet_intelligence_discovery_pipeline_bridge import (
    WalletIntelligenceDiscoveryPipelineBridge,
)
...
if "WalletIntelligenceDiscoveryPipelineBridge" not in existing_init:
    INIT_FILE.write_text(existing_init.rstrip() + "\n" + INIT_EXPORT.lstrip(), encoding="utf-8")

print("========================================")
print(" WDM-006 INSTALLER")
print(" Wallet Intelligence Discovery Pipeline Bridge")
print("========================================")
print(f"[OK] Wrote {BRIDGE_FILE}")
print(f"[OK] Wrote {TEST_FILE}")
print(f"[OK] Updated {INIT_FILE}")
print()
print("[DONE] WDM-006 installed")
print()
print("Run:")
print("py test_wdm_006_wallet_intelligence_discovery_pipeline_bridge.py")