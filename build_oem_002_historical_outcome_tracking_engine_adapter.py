...
ROOT = Path.cwd()
TARGET = ROOT / "qseries_v2" / "integration" / "historical_outcome_tracking_engine_adapter.py"
TEST = ROOT / "test_oem_002_historical_outcome_tracking_engine_adapter.py"
...
export = (
    "from .historical_outcome_tracking_engine_adapter import "
    "HistoricalOutcomeTrackingEngineAdapter, "
    "create_historical_outcome_tracking_engine_adapter, "
    "historical_outcome_tracking_engine_adapter, "
    "oracle_outcome_tracking_adapter, oracle_outcome_adapter\n"
)
...
print("========================================")
print(" OEM-002 INSTALLER")
print(" Historical Outcome Tracking Engine Adapter")
print("========================================")
print(f"[OK] Wrote {TARGET}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {init_path}")
print("")
print("[DONE] OEM-002 installed")
print("")
print("Run:")
print("py test_oem_002_historical_outcome_tracking_engine_adapter.py")