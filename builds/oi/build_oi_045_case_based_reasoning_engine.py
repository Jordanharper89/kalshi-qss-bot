...
ENGINE = OI_DIR / "case_based_reasoning_engine.py"
TEST = ROOT / "test_oi_045_case_based_reasoning_engine.py"
...
export_line = "from .case_based_reasoning_engine import case_based_reasoning_engine, CaseBasedReasoningEngine\n"
...
print(" Case-Based Reasoning Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-045 installed")
print()
print("Run:")
print("python test_oi_045_case_based_reasoning_engine.py")