"""
build_oi_015_oracle_intelligence_service.py
OI-015 Oracle Intelligence Service Installer
"""
...
print(" Oracle Intelligence Service")
print("=" * 40)

write(OI / "oracle_intelligence_service.py", service_code)
write(OI / "__init__.py", init_code)
write(ROOT / "test_oi_015_oracle_intelligence_service.py", test_code)

print("\n[DONE] OI-015 installed")
print("\nRun:")
print("python test_oi_015_oracle_intelligence_service.py")