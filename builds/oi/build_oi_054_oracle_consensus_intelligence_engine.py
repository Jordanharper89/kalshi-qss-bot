...
ENGINE = OI_DIR / "oracle_consensus_intelligence_engine.py"
TEST = ROOT / "test_oi_054_oracle_consensus_intelligence_engine.py"
...
test_code = r'''from qseries_v2.oracle_intelligence.oracle_consensus_intelligence_engine import OracleConsensusIntelligenceEngine
...
export_line = "from .oracle_consensus_intelligence_engine import oracle_consensus_intelligence_engine, OracleConsensusIntelligenceEngine\n"
...
print(" Oracle Consensus Intelligence Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-054 installed")
print()
print("Run:")
print("python test_oi_054_oracle_consensus_intelligence_engine.py")