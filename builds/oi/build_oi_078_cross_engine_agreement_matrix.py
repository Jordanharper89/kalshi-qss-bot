...
ENGINE = OI_DIR / "cross_engine_agreement_matrix.py"
TEST = ROOT / "test_oi_078_cross_engine_agreement_matrix.py"
...
test_code = r'''from qseries_v2.oracle_intelligence.cross_engine_agreement_matrix import CrossEngineAgreementMatrix
...
export_line = "from .cross_engine_agreement_matrix import cross_engine_agreement_matrix, CrossEngineAgreementMatrix\n"
...
print("========================================")
print(" OI-078 INSTALLER")
print(" Cross-Engine Agreement Matrix")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-078 installed")
print()
print("Run:")
print("python test_oi_078_cross_engine_agreement_matrix.py")