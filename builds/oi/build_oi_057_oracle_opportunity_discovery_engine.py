...
ENGINE = OI_DIR / "oracle_opportunity_discovery_engine.py"
TEST = ROOT / "test_oi_057_oracle_opportunity_discovery_engine.py"
...
test_code = r'''from qseries_v2.oracle_intelligence.oracle_opportunity_discovery_engine import oracle_opportunity_discovery_engine
...
export_line = "from .oracle_opportunity_discovery_engine import oracle_opportunity_discovery_engine, OracleOpportunityDiscoveryEngine\n"
...
print("========================================")
print(" OI-057 INSTALLER")
print(" Oracle Opportunity Discovery Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-057 installed")
print()
print("Run:")
print("python test_oi_057_oracle_opportunity_discovery_engine.py")