...
ENGINE = PKG / "oracle_handoff_validation_engine.py"
TEST = ROOT / "test_oi_116_oracle_handoff_validation_engine.py"
...
line = "from .oracle_handoff_validation_engine import oracle_handoff_validation_engine\n"
if line not in init_text:
    INIT.write_text(init_text.rstrip() + "\n" + line, encoding="utf-8")

print("========================================")
print(" OI-116 INSTALLER")
print(" Oracle Handoff Validation Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-116 installed")
print()
print("Run:")
print("py test_oi_116_oracle_handoff_validation_engine.py")