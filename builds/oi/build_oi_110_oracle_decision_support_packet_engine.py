...
ENGINE = PKG / "oracle_decision_support_packet_engine.py"
TEST = ROOT / "test_oi_110_oracle_decision_support_packet_engine.py"
...
line = "from .oracle_decision_support_packet_engine import oracle_decision_support_packet_engine\n"
if line not in init_text:
    INIT.write_text(init_text.rstrip() + "\n" + line, encoding="utf-8")

print("========================================")
print(" OI-110 INSTALLER")
print(" Oracle Decision Support Packet Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-110 installed")
print()
print("Run:")
print("py test_oi_110_oracle_decision_support_packet_engine.py")