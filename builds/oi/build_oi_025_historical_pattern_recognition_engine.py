...
TEST_FILE = ROOT / "test_oi_025_historical_pattern_recognition_engine.py"

OI_DIR.mkdir(parents=True, exist_ok=True)

ENGINE = OI_DIR / "historical_pattern_recognition_engine.py"
...
line = "from .historical_pattern_recognition_engine import HistoricalPatternRecognitionEngine, oracle_pattern_engine\n"
...
print(" Historical Pattern Recognition Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST_FILE}")
print(f"[OK] Updated {INIT}")
print("")
print("[DONE] OI-025 installed")
print("")
print("Run:")
print("python test_oi_025_historical_pattern_recognition_engine.py")