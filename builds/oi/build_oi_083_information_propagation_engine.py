...
ENGINE = OI_DIR / "information_propagation_engine.py"
TEST = ROOT / "test_oi_083_information_propagation_engine.py"
...
test_code = r'''from qseries_v2.oracle_intelligence.information_propagation_engine import InformationPropagationEngine
...
export_line = "from .information_propagation_engine import information_propagation_engine, InformationPropagationEngine\n"
if export_line not in init_text:
    init_text += "\n" + export_line
INIT.write_text(init_text, encoding="utf-8")

print("========================================")
print(" OI-083 INSTALLER")
print(" Information Propagation Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-083 installed")
print()
print("Run:")
print("python test_oi_083_information_propagation_engine.py")