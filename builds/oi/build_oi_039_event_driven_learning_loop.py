...
TEST_FILE = ROOT / "test_oi_039_event_driven_learning_loop.py"

OI_DIR.mkdir(parents=True, exist_ok=True)

ENGINE = OI_DIR / "event_driven_learning_loop.py"
...
line = "from .event_driven_learning_loop import EventDrivenLearningLoop, oracle_event_learning_loop\n"
...
print(" Event-Driven Learning Loop")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST_FILE}")
print(f"[OK] Updated {INIT}")
print("")
print("[DONE] OI-039 installed")
print("")
print("Run:")
