...
ENGINE = PKG / "market_influence_graph_engine.py"
TEST = ROOT / "test_oi_086_market_influence_graph_engine.py"
...
line = "from .market_influence_graph_engine import market_influence_graph_engine\n"
if line not in init_text:
    INIT.write_text(init_text.rstrip() + "\n" + line, encoding="utf-8")

print("========================================")
print(" OI-086 INSTALLER")
print(" Market Influence Graph Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-086 installed")
print()
print("Run:")
