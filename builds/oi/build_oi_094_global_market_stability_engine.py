...
ENGINE = PKG / "global_market_stability_engine.py"
TEST = ROOT / "test_oi_094_global_market_stability_engine.py"
...
line = "from .global_market_stability_engine import global_market_stability_engine\n"
if line not in init_text:
    INIT.write_text(init_text.rstrip() + "\n" + line, encoding="utf-8")

print("========================================")
print(" OI-094 INSTALLER")
print(" Global Market Stability Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-094 installed")
print()
print("Run:")
print("python test_oi_094_global_market_stability_engine.py")
