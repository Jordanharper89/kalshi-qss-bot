...
ENGINE = OI_DIR / "research_drift_detection_engine.py"
TEST = ROOT / "test_oi_064_research_drift_detection_engine.py"
...
test_code = r'''from qseries_v2.oracle_intelligence.research_drift_detection_engine import research_drift_detection_engine
...
export_line = "from .research_drift_detection_engine import research_drift_detection_engine, ResearchDriftDetectionEngine\n"
...
print(" Research Drift Detection Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-064 installed")
print()
print("Run:")
print("python test_oi_064_research_drift_detection_engine.py")