...
ENGINE = PKG / "qseries_visibility_archive_index_engine.py"
TEST = ROOT / "test_oi_135_qseries_visibility_archive_index_engine.py"
...
line = (
    "from .qseries_visibility_archive_index_engine "
    "import qseries_visibility_archive_index_engine\n"
)
...
print("========================================")
print(" OI-135 INSTALLER")
print(" Q Series Visibility Archive Index Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-135 installed")
print()
print("Run:")
print("py test_oi_135_qseries_visibility_archive_index_engine.py")