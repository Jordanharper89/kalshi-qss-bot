...
ENGINE = PKG / "risk_posture_synthesis_engine.py"
TEST = ROOT / "test_oi_102_risk_posture_synthesis_engine.py"
...
line = "from .risk_posture_synthesis_engine import risk_posture_synthesis_engine\n"
if line not in init_text:
    INIT.write_text(init_text.rstrip() + "\n" + line, encoding="utf-8")

print("========================================")
print(" OI-102 INSTALLER")
print(" Risk Posture Synthesis Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-102 installed")
print()
print("Run:")
print("py test_oi_102_risk_posture_synthesis_engine.py")