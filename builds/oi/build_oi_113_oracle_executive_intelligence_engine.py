...
MODULE = PKG / "oracle_executive_intelligence_engine.py"
TEST = ROOT / "test_oi_113_oracle_executive_intelligence_engine.py"
...
export_line = "from .oracle_executive_intelligence_engine import build_executive_intelligence, oracle_executive_intelligence_engine\n"
if export_line not in init_text:
    init_text += "\n" + export_line
    INIT.write_text(init_text, encoding="utf-8")

print("=" * 40)
print(" OI-113 INSTALLER")
print(" Oracle Executive Intelligence Engine")
print("=" * 40)
print(f"[OK] Wrote {MODULE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print("\n[DONE] OI-113 installed")
print("\nRun:")
print("py test_oi_113_oracle_executive_intelligence_engine.py")