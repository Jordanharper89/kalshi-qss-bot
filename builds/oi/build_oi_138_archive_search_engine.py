...
ENGINE = PKG / "archive_search_engine.py"
TEST = ROOT / "test_oi_138_archive_search_engine.py"
...
line = "from .archive_search_engine import archive_search_engine\n"
if line not in init_text:
    INIT.write_text(init_text.rstrip() + "\n" + line, encoding="utf-8")

print("========================================")
print(" OI-138 INSTALLER")
print(" Archive Search Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-138 installed")
print()
print("Run:")
print("py test_oi_138_archive_search_engine.py")