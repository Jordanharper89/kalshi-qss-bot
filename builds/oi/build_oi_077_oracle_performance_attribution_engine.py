...
ENGINE = OI_DIR / "oracle_performance_attribution_engine.py"
TEST = ROOT / "test_oi_077_oracle_performance_attribution_engine.py"
...
test_code = r'''from qseries_v2.oracle_intelligence.oracle_performance_attribution_engine import OraclePerformanceAttributionEngine
...
export_line = "from .oracle_performance_attribution_engine import oracle_performance_attribution_engine, OraclePerformanceAttributionEngine\n"
...
print("========================================")
print(" OI-077 INSTALLER")
print(" Oracle Performance Attribution Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-077 installed")
print()
print("Run:")
print("python test_oi_077_oracle_performance_attribution_engine.py")