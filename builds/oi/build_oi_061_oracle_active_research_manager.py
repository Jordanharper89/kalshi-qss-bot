...
ENGINE = OI_DIR / "oracle_active_research_manager.py"
TEST = ROOT / "test_oi_061_oracle_active_research_manager.py"
...
test_code = r'''from qseries_v2.oracle_intelligence.oracle_active_research_manager import OracleActiveResearchManager
...
export_line = "from .oracle_active_research_manager import oracle_active_research_manager, OracleActiveResearchManager\n"
...
print(" Oracle Active Research Manager")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-061 installed")
print()
print("Run:")
print("python test_oi_061_oracle_active_research_manager.py")