...
TEST_FILE = ROOT / "test_oi_037_market_relationship_engine.py"

OI_DIR.mkdir(parents=True, exist_ok=True)

ENGINE = OI_DIR / "market_relationship_engine.py"
...
line = "from .market_relationship_engine import MarketRelationshipEngine, oracle_relationship_engine\n"
...
print(" Market Relationship Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST_FILE}")
print(f"[OK] Updated {INIT}")
print("")
print("[DONE] OI-037 installed")
print("")
print("Run:")
print("python test_oi_037_market_relationship_engine.py")