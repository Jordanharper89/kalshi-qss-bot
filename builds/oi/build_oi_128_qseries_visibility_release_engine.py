...
ENGINE = PKG / "qseries_visibility_release_engine.py"
TEST = ROOT / "test_oi_128_qseries_visibility_release_engine.py"
...
line = "from .qseries_visibility_release_engine import qseries_visibility_release_engine\n"
if line not in init_text:
    INIT.write_text(init_text.rstrip() + "\n" + line, encoding="utf-8")

print("========================================")
print(" OI-128 INSTALLER")
print(" Q Series Visibility Release Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-128 installed")
print()
print("Run:")
print("py test_oi_128_qseries_visibility_release_engine.py")