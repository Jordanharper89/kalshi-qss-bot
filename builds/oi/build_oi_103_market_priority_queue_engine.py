...
ENGINE = PKG / "market_priority_queue_engine.py"
TEST = ROOT / "test_oi_103_market_priority_queue_engine.py"
...
line = "from .market_priority_queue_engine import market_priority_queue_engine\n"
if line not in init_text:
    INIT.write_text(init_text.rstrip() + "\n" + line, encoding="utf-8")

print("========================================")
print(" OI-103 INSTALLER")
print(" Market Priority Queue Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-103 installed")
print()
print("Run:")
print("py test_oi_103_market_priority_queue_engine.py")