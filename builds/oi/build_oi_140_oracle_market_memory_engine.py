...
ENGINE = PKG / "oracle_market_memory_engine.py"
TEST = ROOT / "test_oi_140_oracle_market_memory_engine.py"
...
line = "from .oracle_market_memory_engine import oracle_market_memory_engine\n"
if line not in init_text:
    INIT.write_text(init_text.rstrip() + "\n" + line, encoding="utf-8")

print("========================================")
print(" OI-140 INSTALLER")
print(" Oracle Market Memory Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-140 installed")
print()
print("Run:")
print("py test_oi_140_oracle_market_memory_engine.py")