...
ENGINE = OI_DIR / "oracle_runtime_state_store.py"
TEST = ROOT / "test_oi_069_oracle_runtime_state_store.py"
...
export_line = "from .oracle_runtime_state_store import oracle_runtime_state_store, OracleRuntimeStateStore\n"
...
print("========================================")
print(" OI-069 INSTALLER")
print(" Oracle Runtime State Store")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-069 installed")
print()
print("Run:")
print("python test_oi_069_oracle_runtime_state_store.py")