...
ENGINE = PKG / "oracle_knowledge_recall_engine.py"
TEST = ROOT / "test_oi_147_oracle_knowledge_recall_engine.py"
...
line = "from .oracle_knowledge_recall_engine import oracle_knowledge_recall_engine\n"
if line not in init_text:
    INIT.write_text(init_text.rstrip() + "\n" + line, encoding="utf-8")

print("========================================")
print(" OI-147 INSTALLER")
print(" Oracle Knowledge Recall Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OI-147 installed")
print()
print("Run:")
print("py test_oi_147_oracle_knowledge_recall_engine.py")