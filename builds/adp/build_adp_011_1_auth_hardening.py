...
Path("test_adp_011_1_auth_hardening.py").write_text(test_code, encoding="utf-8")

print("========================================")
print(" ADP-011.1 INSTALLER")
print(" Production Auth Hardening")
print("========================================")
print("[OK] Wrote qseries_v2\\adapters\\live_kalshi_authentication.py")
print("[OK] Wrote qseries_v2\\adapters\\__init__.py")
print("[OK] Wrote test_adp_011_1_auth_hardening.py")
print()
print("[DONE] ADP-011.1 installed")
print()
print("Run:")
print("python test_adp_011_1_auth_hardening.py")
print()
print("Optional live credential validation:")
