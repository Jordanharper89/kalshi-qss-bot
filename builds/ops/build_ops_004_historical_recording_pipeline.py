...
(OPS / "historical_recording_pipeline.py").write_text(pipeline_code, encoding="utf-8")
(OPS / "__init__.py").write_text(init_code, encoding="utf-8")
Path("test_ops_004_historical_recording_pipeline.py").write_text(test_code, encoding="utf-8")

print("========================================")
print(" OPS-004 INSTALLER")
print(" Historical Recording Pipeline")
print("========================================")
print("[OK] Wrote qseries_v2\\ops\\historical_recording_pipeline.py")
print("[OK] Wrote qseries_v2\\ops\\__init__.py")
print("[OK] Wrote test_ops_004_historical_recording_pipeline.py")
print()
print("[DONE] OPS-004 installed")
print()
print("Run:")
print("python test_ops_004_historical_recording_pipeline.py")