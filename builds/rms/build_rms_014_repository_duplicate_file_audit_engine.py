...
MODULE = PKG / "repository_duplicate_file_audit_engine.py"
TEST = TEST_DIR / "test_rms_014_repository_duplicate_file_audit_engine.py"
...
def update_init() -> None:
    ...
    line = "from .repository_duplicate_file_audit_engine import RepositoryDuplicateFileAuditEngine, audit_repository_duplicate_files\n"
...
def main():
    ...
    print("========================================")
    print(" RMS-014 INSTALLER")
    print(" Repository Duplicate File Audit Engine")
    print("========================================")
    print(f"[OK] Wrote {MODULE}")
    print(f"[OK] Wrote {TEST}")
    print(f"[OK] Updated {INIT}")
    print()
    print("[DONE] RMS-014 installed")
    print()
    print("Run:")
    print("py tests\\rms\\test_rms_014_repository_duplicate_file_audit_engine.py")
