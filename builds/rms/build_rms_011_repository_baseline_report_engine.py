...
MODULE = PKG / "repository_baseline_report_engine.py"
INIT = PKG / "__init__.py"
TEST = TEST_DIR / "test_rms_011_repository_baseline_report_engine.py"
...
def update_init() -> None:
    ...
    line = "from .repository_baseline_report_engine import RepositoryBaselineReportEngine, generate_repository_baseline_report\n"
...
def main():
    ...
    print("========================================")
    print(" RMS-011 INSTALLER")
    print(" Repository Baseline Report Engine")
    print("========================================")
    print(f"[OK] Wrote {MODULE}")
    print(f"[OK] Wrote {TEST}")
    print(f"[OK] Updated {INIT}")
    print()
    print("[DONE] RMS-011 installed")
    print()
    print("Run:")
    print("py tests\\rms\\test_rms_011_repository_baseline_report_engine.py")
