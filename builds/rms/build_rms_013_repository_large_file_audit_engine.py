...
MODULE = PKG / "repository_large_file_audit_engine.py"
TEST = TEST_DIR / "test_rms_013_repository_large_file_audit_engine.py"
...
def update_init() -> None:
    ...
    line = "from .repository_large_file_audit_engine import RepositoryLargeFileAuditEngine, audit_repository_large_files\n"
...
def main():
    ...
    print("========================================")
    print(" RMS-013 INSTALLER")
    print(" Repository Large File Audit Engine")
    print("========================================")
    print(f"[OK] Wrote {MODULE}")
    print(f"[OK] Wrote {TEST}")
    print(f"[OK] Updated {INIT}")
    print()
    print("[DONE] RMS-013 installed")
    print()
    print("Run:")
    print("py tests\\rms\\test_rms_013_repository_large_file_audit_engine.py")
