...
MODULE = PKG / "liquidity_pipeline_bridge.py"
TEST = ROOT / "test_lqd_006_liquidity_pipeline_bridge.py"
...
'''
if "liquidity_pipeline_bridge" not in existing:
    INIT.write_text(existing.rstrip() + "\n" + exports.lstrip(), encoding="utf-8")

print("========================================")
print(" LQD-006 INSTALLER")
print(" Liquidity Pipeline Bridge")
print("========================================")
print(f"[OK] Wrote {MODULE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] LQD-006 installed")
print()
print("Run:")
print("py test_lqd_006_liquidity_pipeline_bridge.py")