...
ROOT = Path.cwd()
TARGET = ROOT / "qseries_v2" / "ops" / "qseries_runtime.py"
TEST = ROOT / "test_ops_008_qseries_runtime_runtime_path_migration.py"
...
export = (
    ...
    "RuntimeServiceStatus, RuntimeWatchdogStatus, RuntimeStatus, "
    "QSeriesRuntime, create_qseries_runtime, qseries_runtime\n"
)
...
print("========================================")
print(" OPS-008 INSTALLER")
print(" Q Series Runtime Runtime Path Migration")
print("========================================")
print(f"[OK] Wrote {TARGET}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {init_path}")
print("")
print("[DONE] OPS-008 installed")
print("")
print("Run:")
print("py test_ops_008_qseries_runtime_runtime_path_migration.py")