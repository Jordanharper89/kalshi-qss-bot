...
GATE_FILE = MODULE_DIR / "social_intelligence_subsystem_integration_gate.py"
TEST_FILE = ROOT / "test_sid_009_social_intelligence_subsystem_integration_gate.py"
...
if "SocialIntelligenceSubsystemIntegrationGate" not in existing:
    INIT_FILE.write_text(existing.rstrip() + "\n" + INIT_EXPORT.lstrip(), encoding="utf-8")

print("========================================")
print(" SID-009 INSTALLER")
print(" Social Intelligence Subsystem Integration Gate")
print("========================================")
print(f"[OK] Wrote {GATE_FILE}")
print(f"[OK] Wrote {TEST_FILE}")
print(f"[OK] Updated {INIT_FILE}")
print()
print("[DONE] SID-009 installed")
print()
print("Run:")
print("py test_sid_009_social_intelligence_subsystem_integration_gate.py")