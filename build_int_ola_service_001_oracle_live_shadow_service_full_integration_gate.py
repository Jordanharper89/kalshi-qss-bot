...
TEST_PATH = (
    ROOT
    / "test_int_ola_service_001_oracle_live_shadow_service_full_integration_gate.py"
)
...
def main() -> None:
    print("========================================")
    print(" INT-OLA-SERVICE-001 INSTALLER")
    ...
    print()
    print("[DONE] INT-OLA-SERVICE-001 installed")
    print()
    print("Run:")
    print(
        "py test_int_ola_service_001_oracle_live_shadow_"
        "service_full_integration_gate.py"
    )
