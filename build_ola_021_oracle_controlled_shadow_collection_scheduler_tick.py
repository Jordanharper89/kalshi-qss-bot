...
MODULE_PATH = (
    PACKAGE_DIR
    / "oracle_controlled_shadow_collection_scheduler_tick.py"
)
...
TEST_PATH = (
    ROOT
    / "test_ola_021_oracle_controlled_shadow_collection_scheduler_tick.py"
)
...
def update_package_exports() -> None:
    ...
    import_marker = (
        "from .oracle_controlled_shadow_collection_"
        "scheduler_tick import"
    )
...
def main() -> None:
    print("========================================")
    print(" OLA-021 INSTALLER")
    print(" Oracle Controlled Shadow Collection")
    ...
    print()
    print("[DONE] OLA-021 installed")
    print()
    print("Run:")
    print(
        "py test_ola_021_oracle_controlled_shadow_"
        "collection_scheduler_tick.py"
    )
