...
MODULE_PATH = (
    ...
    / "oracle_production_evidence_service_runner_full_integration_gate.py"
)

TEST_PATH = (
    ROOT
    / "test_int_ola_prod_evidence_001_oracle_production_evidence_service_runner_full_integration_gate.py"
)
...
def main() -> None:
    ...
    print(
        " INT-OLA-PROD-EVIDENCE-001 "
        "CORRECTION INSTALLER"
    )
    print(
        " ACTUAL OLA-023 NESTED "
    ...
    print()
    print(
        "[DONE] INT-OLA-PROD-EVIDENCE-001 "
        "correction installed"
    )
    print()
    print("Run:")
    print(
        "py test_int_ola_prod_evidence_001_"
        "oracle_production_evidence_service_runner_"
        "full_integration_gate.py"
    )
