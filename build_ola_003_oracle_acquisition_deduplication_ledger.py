...
MODULE_PATH = (
    PACKAGE_DIR
    / "oracle_acquisition_deduplication_ledger.py"
)
...
TEST_PATH = (
    ROOT
    / "test_ola_003_oracle_acquisition_deduplication_ledger.py"
)
...
def main() -> None:
    print("========================================")
    print(" OLA-003 INSTALLER")
    print(" Oracle Acquisition Deduplication Ledger")
    print(" FULL CANONICAL HASH CONTRACT REWRITE")
    print("========================================")
