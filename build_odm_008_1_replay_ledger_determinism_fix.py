...
LEDGER_FILE = ROOT / "qseries_v2" / "oracle_intelligence" / "oracle_discovery_model" / "prediction_market_discovery_replay_ledger.py"
...
print("========================================")
print(" ODM-008.1 INSTALLER")
print(" Replay Ledger Determinism Fix")
print("========================================")
print(f"[OK] Rewrote {LEDGER_FILE}")
print(f"[OK] Rewrote {TEST_FILE}")
print()
print("[DONE] ODM-008.1 installed")
print()
print("Run:")
