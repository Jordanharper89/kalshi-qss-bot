...
TARGET = Path("oracle_adaptive_ranking.py")
...
print("===================================")
print(" ORACLE-033 INSTALLED")
print(" Adaptive Opportunity Ranking")
print("===================================")
print()
print("Created:")
print(" oracle_adaptive_ranking.py")
print()
print("Test:")
print(" python oracle_adaptive_ranking.py")