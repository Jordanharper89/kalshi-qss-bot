...
TARGET = Path("oracle_learning_terminal.py")
...
def backup(path):
    ...
    b = path.with_suffix(path.suffix + f".bak_oracle071_{stamp}")
    shutil.copy2(path, b)
    return b
...
def main():
    print("===================================")
    print(" ORACLE-071 INSTALLER")
    print(" Learning Summary Terminal")
    print("===================================")

    b = backup(TARGET)
    TARGET.write_text(CODE, encoding="utf-8")

    print("[OK] Created oracle_learning_terminal.py")
    if b:
        print(f"[OK] Backup created: {b}")

    print("")
    print("Tests:")
    print(" python oracle_learning_terminal.py")
    print(" python oracle_learning_terminal.py 10")
    print(" python oracle_learning_terminal.py 5 full")
    print("")
    print("[DONE] ORACLE-071 Learning Summary Terminal installed")
