...
TARGET = Path("oracle_kalshi_event_market_loader.py")
...
print("===================================")
print(" ORACLE-039.6 INSTALLED")
print(" Kalshi Event Market Loader")
print("===================================")
print()
print("Test:")
print(" python oracle_kalshi_event_market_loader.py")