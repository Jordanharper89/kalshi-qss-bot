...
TARGET = Path("oracle_market_universe_filter.py")
...
print("===================================")
print(" ORACLE-039.4 INSTALLED")
print(" Market Universe Filter")
print("===================================")
print()
print("Created:")
print(" oracle_market_universe_filter.py")
print()
print("Test:")
print(" python oracle_market_universe_filter.py")