...
def backup(path):
    ...
    b = path.with_suffix(path.suffix + f".bak_kq021_clean_{stamp}")
    shutil.copy2(path, b)
    return b
...
def main():
    print("===================================")
    print(" KQ-021 INSTALLER")
    print(" Clean Telegram Bot Rewrite")
    print("===================================")
    ...
    b = backup(BOT)
    BOT.write_text(CLEAN_BOT, encoding="utf-8")

    print("[OK] Rewrote telegram_bot.py clean")
    ...
    print("")
    print("[DONE] KQ-021 clean rewrite installed")
