...
target = ROOT / "oracle_opportunity_intelligence.py"
backup(target)
...
print("✅ Created oracle_opportunity_intelligence.py")
print("[DONE] ORACLE-028 Opportunity Intelligence Engine installed")
print("")
print("Test it with:")
print("python oracle_opportunity_intelligence.py")