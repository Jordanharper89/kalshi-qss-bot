...
TARGET = Path("oracle_market_intelligence.py")
...
def classify_market(market):
    ...
    if any(x in blob for x in ["ipo", "stock", "shares", "nasdaq", "nyse", "sec", "earnings"]):
        domain = "financials"
...
print("===================================")
print(" ORACLE-040 INSTALLED")
print(" Market Intelligence Engine")
print("===================================")
print()
print("Created:")
print(" oracle_market_intelligence.py")
print()
print("Test:")
