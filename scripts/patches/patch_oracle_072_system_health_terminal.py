...
TARGET = Path("oracle_system_health.py")
...
def backup(path):
    ...
    b = path.with_suffix(path.suffix + f".bak_oracle072_{stamp}")
    shutil.copy2(path, b)
    return b
...
def main():
    print("===================================")
    print(" ORACLE-072 INSTALLER")
    print(" System Health Terminal")
    print("===================================")

    b = backup(TARGET)
    TARGET.write_text(CODE, encoding="utf-8")

    print("[OK] Created oracle_system_health.py")
    if b:
        print(f"[OK] Backup created: {b}")

    print("")
    print("Tests:")
    print(" python oracle_system_health.py")
    print("")
    print("[DONE] ORACLE-072 System Health Terminal installed")
