...
TARGET = Path("oracle_market_data_field_mapper.py")
...
def backup(path):
    ...
    b = path.with_suffix(path.suffix + f".bak_oracle080_{stamp}")
    shutil.copy2(path, b)
    return b
...
def main():
    print("===================================")
    print(" ORACLE-080 INSTALLER")
    print(" Market Data Field Mapper")
    print("===================================")

    b = backup(TARGET)
    TARGET.write_text(CODE, encoding="utf-8")

    print("[OK] Created oracle_market_data_field_mapper.py")
    if b:
        print(f"[OK] Backup created: {b}")

    print("")
    print("Tests:")
    print(" python oracle_market_data_field_mapper.py")
    print("")
    print("[DONE] ORACLE-080 Market Data Field Mapper installed")
