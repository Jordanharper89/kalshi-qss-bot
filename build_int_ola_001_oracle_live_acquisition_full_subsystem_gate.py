...
TEST_PATH = (
    ROOT
    / "test_int_ola_001_oracle_live_acquisition_full_subsystem_gate.py"
)
...
def main() -> None:
    print("========================================")
    print(" INT-OLA-001 INSTALLER")
    print(" Oracle Live Acquisition")
    print(" Full OLA-001 Through OLA-010")
    print(" Subsystem Integration Gate")
    print("========================================")
    ...
    print()
    print("[DONE] INT-OLA-001 installed")
    print()
    print("Run:")
    print(
        "py test_int_ola_001_oracle_live_acquisition_"
        "full_subsystem_gate.py"
    )
