...
MODULE = PKG / "order_flow_subsystem_integration_gate.py"
TEST = ROOT / "test_ofd_009_order_flow_subsystem_integration_gate.py"
...
'''
if "order_flow_subsystem_integration_gate" not in existing:
    INIT.write_text(existing.rstrip() + "\n" + exports.lstrip(), encoding="utf-8")

print("========================================")
print(" OFD-009 INSTALLER")
print(" Order Flow Subsystem Integration Gate")
print("========================================")
print(f"[OK] Wrote {MODULE}")
print(f"[OK] Wrote {TEST}")
print(f"[OK] Updated {INIT}")
print()
print("[DONE] OFD-009 installed")
print()
print("Run:")
print("py test_ofd_009_order_flow_subsystem_integration_gate.py")