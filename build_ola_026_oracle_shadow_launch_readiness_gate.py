...
MODULE_PATH = (
    ...
    / "oracle_shadow_launch_readiness_gate.py"
)

TEST_PATH = (
    ROOT
    / "test_ola_026_oracle_shadow_launch_readiness_gate.py"
)
...
def main() -> None:
    print("========================================")
    print(" OLA-026 CORRECTION INSTALLER")
    print(" CANONICAL SOURCE EVIDENCE HASHING")
    print("========================================")
    ...
    print()
    print(
        "[DONE] OLA-026 correction installed"
    )
    print()
    print("Run:")
    print(
        "py test_ola_026_oracle_shadow_"
        "launch_readiness_gate.py"
    )
