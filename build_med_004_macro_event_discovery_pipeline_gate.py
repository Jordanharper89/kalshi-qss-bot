...
GATE_FILE = MODULE_DIR / "macro_event_discovery_pipeline_gate.py"
TEST_FILE = ROOT / "test_med_004_macro_event_discovery_pipeline_gate.py"
...
if "MacroEventDiscoveryPipelineGate" not in existing:
    INIT_FILE.write_text(existing.rstrip() + "\n" + INIT_EXPORT.lstrip(), encoding="utf-8")

print("========================================")
print(" MED-004 INSTALLER")
print(" Macro Event Discovery Pipeline Gate")
print("========================================")
print(f"[OK] Wrote {GATE_FILE}")
print(f"[OK] Wrote {TEST_FILE}")
print(f"[OK] Updated {INIT_FILE}")
print()
print("[DONE] MED-004 installed")
print()
print("Run:")
print("py test_med_004_macro_event_discovery_pipeline_gate.py")