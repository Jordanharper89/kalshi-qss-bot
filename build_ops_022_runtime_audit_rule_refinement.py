...
TEST = ROOT / "test_ops_022_runtime_audit_rule_refinement.py"
...
print("========================================")
print(" OPS-022 INSTALLER")
print(" Runtime Audit Rule Refinement")
print("========================================")
print(f"[OK] Rewrote {TARGET}")
print(f"[OK] Wrote {TEST}")
print("")
print("[DONE] OPS-022 installed")
print("")
print("Run:")
print("py test_ops_022_runtime_audit_rule_refinement.py")