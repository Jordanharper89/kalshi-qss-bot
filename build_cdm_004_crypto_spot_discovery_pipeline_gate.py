...
GATE_FILE = MODULE_DIR / "crypto_spot_discovery_pipeline_gate.py"
TEST_FILE = ROOT / "test_cdm_004_crypto_spot_discovery_pipeline_gate.py"
...
TEST_CODE = r'''from qseries_v2.oracle_intelligence.crypto_discovery_model.crypto_spot_discovery_pipeline_gate import (
    CryptoSpotDiscoveryPipelineGate,
)
...
if "CryptoSpotDiscoveryPipelineGate" not in existing_init:
    INIT_FILE.write_text(existing_init.rstrip() + "\n" + INIT_EXPORT.lstrip(), encoding="utf-8")

print("========================================")
print(" CDM-004 INSTALLER")
print(" Crypto Spot Discovery Pipeline Gate")
print("========================================")
print(f"[OK] Wrote {GATE_FILE}")
print(f"[OK] Wrote {TEST_FILE}")
print(f"[OK] Updated {INIT_FILE}")
print()
print("[DONE] CDM-004 installed")
print()
print("Run:")
print("py test_cdm_004_crypto_spot_discovery_pipeline_gate.py")