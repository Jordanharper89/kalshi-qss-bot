...
MODULE_PATH = (
    PACKAGE_DIR
    / "oracle_shadow_polling_policy_cadence_engine.py"
)
...
TEST_PATH = (
    ROOT
    / "test_ola_019_oracle_shadow_polling_policy_cadence_engine.py"
)
...
def update_package_exports() -> None:
    ...
    import_marker = (
        "from .oracle_shadow_polling_policy_cadence_"
        "engine import"
    )
...
def main() -> None:
    print("========================================")
    print(" OLA-019 INSTALLER")
    print(" Oracle Shadow Polling Policy")
    print(" and Cadence Engine")
    print(" FULL SAFETY PRECEDENCE")
    print(" STATE-MACHINE REWRITE")
    print("========================================")
    ...
    print()
    print("[DONE] OLA-019 rewritten")
    print()
    print("Run:")
    print(
        "py test_ola_019_oracle_shadow_polling_policy_"
        "cadence_engine.py"
    )
