...
ENGINE_FILE = MODULE_DIR / "macro_event_discovery_engine.py"
TEST_FILE = ROOT / "test_med_003_macro_event_discovery_engine.py"
...
INIT_EXPORT = '''
try:
    from .macro_event_discovery_engine import (
        MacroEventDiscoveryEngine,
        MacroEventOpportunity,
    )
except Exception:
    pass
'''
...
if "MacroEventDiscoveryEngine" not in existing:
    INIT_FILE.write_text(existing.rstrip() + "\n" + INIT_EXPORT.lstrip(), encoding="utf-8")

print("========================================")
print(" MED-003 INSTALLER")
print(" Macro Event Discovery Engine")
print("========================================")
print(f"[OK] Wrote {ENGINE_FILE}")
print(f"[OK] Wrote {TEST_FILE}")
print(f"[OK] Updated {INIT_FILE}")
print()
print("[DONE] MED-003 installed")
print()
print("Run:")
print("py test_med_003_macro_event_discovery_engine.py")