...
MODULE = PKG / "liquidity_subsystem_integration_gate.py"
TEST = ROOT / "test_lqd_009_liquidity_subsystem_integration_gate.py"
...
print("========================================")
print(" LQD-009 REWRITE INSTALLER")
print(" Liquidity Subsystem Integration Gate")
print("========================================")
print(f"[OK] Rewrote {MODULE}")
print(f"[OK] Rewrote {TEST}")
print()
print("[DONE] LQD-009 rewrite installed")
print()
print("Run:")
print("py test_lqd_009_liquidity_subsystem_integration_gate.py")