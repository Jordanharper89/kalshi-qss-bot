...
TEST_PATH = (
    ROOT
    / "test_int_smoke_004_qseries_execution_adapter_pipeline.py"
)
...
def main() -> None:
    print("========================================")
    print(" INT-SMOKE-004 INSTALLER")
    print(" Q Series Execution Adapter Pipeline")
    ...
    print()
    print("[DONE] INT-SMOKE-004 installed")
    print()
    print("Run:")
    print(
        "py "
