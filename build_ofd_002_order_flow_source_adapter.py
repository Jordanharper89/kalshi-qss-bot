...
MODULE = PKG / "order_flow_source_adapter.py"
TEST = ROOT / "test_ofd_002_order_flow_source_adapter.py"
...
print("========================================")
print(" OFD-002 REWRITE INSTALLER")
print(" Order Flow Source Adapter")
print("========================================")
print(f"[OK] Rewrote {MODULE}")
print(f"[OK] Rewrote {TEST}")
print()
print("[DONE] OFD-002 rewrite installed")
print()
print("Run:")
print("py test_ofd_002_order_flow_source_adapter.py")