...
GATE_FILE = MODULE_DIR / "solana_launch_discovery_pipeline_gate.py"
TEST_FILE = ROOT / "test_sld_004_solana_launch_discovery_pipeline_gate.py"
...
TEST_CODE = r'''from qseries_v2.oracle_intelligence.solana_launch_discovery_model.solana_launch_discovery_pipeline_gate import (
    SolanaLaunchDiscoveryPipelineGate,
)


def test_sld_004_solana_launch_discovery_pipeline_gate():
    gate = SolanaLaunchDiscoveryPipelineGate(
        source_name="sld_004_test_source",
    ...
    assert report.schema_version == "SLD-004"
    assert report.gate_id == "oracle.discovery.gate.solana_launch_pipeline"
    ...
    d = report.to_dict()
    assert d["schema_version"] == "SLD-004"
    ...
    print("[PASS] SLD-004 Solana Launch Discovery Pipeline Gate")
    print(
        {
...
if __name__ == "__main__":
    test_sld_004_solana_launch_discovery_pipeline_gate()
'''
...
if "SolanaLaunchDiscoveryPipelineGate" not in existing_init:
    INIT_FILE.write_text(existing_init.rstrip() + "\n" + INIT_EXPORT.lstrip(), encoding="utf-8")

print("========================================")
print(" SLD-004 INSTALLER")
print(" Solana Launch Discovery Pipeline Gate")
print("========================================")
print(f"[OK] Wrote {GATE_FILE}")
print(f"[OK] Wrote {TEST_FILE}")
print(f"[OK] Updated {INIT_FILE}")
print()
print("[DONE] SLD-004 installed")
print()
print("Run:")
print("py test_sld_004_solana_launch_discovery_pipeline_gate.py")