...
MODULE_PATH = (
    ...
    / "oracle_launch_readiness_artifact_store.py"
)

TEST_PATH = (
    ROOT
    / "test_ola_028_oracle_launch_readiness_artifact_store.py"
)
...
def update_package_export(
    ...
    marker = (
        "from .oracle_launch_readiness_artifact_store "
        "import ("
    )
...
def main() -> None:
    print("========================================")
    print(" OLA-028 INSTALLER")
    print(" Oracle Launch Readiness Artifact Store")
    print("========================================")
    ...
    print()
    print("[DONE] OLA-028 installed")
    print()
    print("Run:")
    print(
        "py test_ola_028_oracle_launch_"
        "readiness_artifact_store.py"
    )
