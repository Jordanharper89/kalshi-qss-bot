...
GATE_FILE = MODULE_DIR / "wallet_intelligence_discovery_oos_runtime_gate.py"
TEST_FILE = ROOT / "test_wdm_007_wallet_intelligence_discovery_oos_runtime_gate.py"
...
TEST_CODE = r'''from qseries_v2.oracle_intelligence.wallet_intelligence_discovery_model.wallet_intelligence_discovery_oos_runtime_gate import (
    WalletIntelligenceDiscoveryOOSRuntimeGate,
)


def test_wdm_007_wallet_intelligence_discovery_oos_runtime_gate():
    gate = WalletIntelligenceDiscoveryOOSRuntimeGate(
        source_name="wdm_007_test_source",
    ...
    assert report.schema_version == "WDM-007"
    assert report.gate_id == "oracle.discovery.gate.wallet_intelligence_oos_runtime"
    ...
    assert report.checks["wallet_intelligence_market_shape"] is True
    assert report.checks["source_engine_id_wallet_intelligence"] is True
    ...
    d = report.to_dict()
    assert d["schema_version"] == "WDM-007"
    ...
    print("[PASS] WDM-007 Wallet Intelligence Discovery OOS Runtime Gate")
    print(
        {
...
if __name__ == "__main__":
    test_wdm_007_wallet_intelligence_discovery_oos_runtime_gate()
'''
...
if "WalletIntelligenceDiscoveryOOSRuntimeGate" not in existing_init:
    INIT_FILE.write_text(existing_init.rstrip() + "\n" + INIT_EXPORT.lstrip(), encoding="utf-8")

print("========================================")
print(" WDM-007 INSTALLER")
print(" Wallet Intelligence Discovery OOS Runtime Gate")
print("========================================")
print(f"[OK] Wrote {GATE_FILE}")
print(f"[OK] Wrote {TEST_FILE}")
print(f"[OK] Updated {INIT_FILE}")
print()
print("[DONE] WDM-007 installed")
print()
print("Run:")
print("py test_wdm_007_wallet_intelligence_discovery_oos_runtime_gate.py")