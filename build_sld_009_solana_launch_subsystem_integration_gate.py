...
GATE_FILE = MODULE_DIR / "solana_launch_subsystem_integration_gate.py"
TEST_FILE = ROOT / "test_sld_009_solana_launch_subsystem_integration_gate.py"
...
TEST_CODE = r'''from qseries_v2.oracle_intelligence.solana_launch_discovery_model.solana_launch_subsystem_integration_gate import (
    SolanaLaunchSubsystemIntegrationGate,
)


def test_sld_009_solana_launch_subsystem_integration_gate():
    gate = SolanaLaunchSubsystemIntegrationGate(
        source_name="sld_009_test_source",
    ...
    assert report.schema_version == "SLD-009"
    assert report.gate_id == "oracle.discovery.gate.solana_launch_subsystem_integration"
    ...
    d = report.to_dict()
    assert d["schema_version"] == "SLD-009"
    ...
    print("[PASS] SLD-009 Solana Launch Subsystem Integration Gate")
    print(
        {
...
if __name__ == "__main__":
    test_sld_009_solana_launch_subsystem_integration_gate()
'''
...
if "SolanaLaunchSubsystemIntegrationGate" not in existing_init:
    INIT_FILE.write_text(existing_init.rstrip() + "\n" + INIT_EXPORT.lstrip(), encoding="utf-8")

print("========================================")
print(" SLD-009 INSTALLER")
print(" Solana Launch Subsystem Integration Gate")
print("========================================")
print(f"[OK] Wrote {GATE_FILE}")
print(f"[OK] Wrote {TEST_FILE}")
print(f"[OK] Updated {INIT_FILE}")
print()
print("[DONE] SLD-009 installed")
print()
print("Run:")
print("py test_sld_009_solana_launch_subsystem_integration_gate.py")