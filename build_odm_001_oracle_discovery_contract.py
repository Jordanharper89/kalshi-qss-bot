...
ODM = ORACLE / "oracle_discovery_model"

MODULE_PATH = ODM / "oracle_discovery_contract.py"
INIT_PATH = ODM / "__init__.py"
ORACLE_INIT_PATH = ORACLE / "__init__.py"
TEST_PATH = ROOT / "test_odm_001_oracle_discovery_contract.py"
...
INIT_CODE = r'''from .oracle_discovery_contract import (
    ODM_VERSION,
    DiscoveryStatus,
    DiscoveryMode,
    DiscoveryCapability,
...
def ensure_dirs():
    ODM.mkdir(parents=True, exist_ok=True)
...
def update_oracle_init():
    ...
    line = "from .oracle_discovery_model import OracleDiscoveryEngineContract, DiscoveryRequest, DiscoveryResult"
...
def main():
    print("=" * 40)
    print(" ODM-001 INSTALLER")
    print(" Oracle Discovery Contract")
    print("=" * 40)
    ...
    print("\n[DONE] ODM-001 installed")
    print("\nRun:")
    print("py test_odm_001_oracle_discovery_contract.py")
