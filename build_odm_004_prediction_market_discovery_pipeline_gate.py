...
GATE_FILE = MODULE_DIR / "prediction_market_discovery_pipeline_gate.py"
TEST_FILE = ROOT / "test_odm_004_prediction_market_discovery_pipeline_gate.py"
...
TEST_CODE = r'''from qseries_v2.oracle_intelligence.oracle_discovery_model.prediction_market_discovery_pipeline_gate import (
    PredictionMarketDiscoveryPipelineGate,
)
...
if "PredictionMarketDiscoveryPipelineGate" not in existing_init:
    INIT_FILE.write_text(existing_init.rstrip() + "\n" + INIT_EXPORT.lstrip(), encoding="utf-8")

print("========================================")
print(" ODM-004 INSTALLER")
print(" Prediction Market Discovery Pipeline Gate")
print("========================================")
print(f"[OK] Wrote {GATE_FILE}")
print(f"[OK] Wrote {TEST_FILE}")
print(f"[OK] Updated {INIT_FILE}")
print()
print("[DONE] ODM-004 installed")
print()
print("Run:")
print("py test_odm_004_prediction_market_discovery_pipeline_gate.py")