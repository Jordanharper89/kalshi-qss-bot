...
GATE_FILE = MODULE_DIR / "cross_venue_arbitrage_discovery_pipeline_gate.py"
TEST_FILE = ROOT / "test_adm_004_cross_venue_arbitrage_discovery_pipeline_gate.py"
...
TEST_CODE = r'''from qseries_v2.oracle_intelligence.arbitrage_discovery_model.cross_venue_arbitrage_discovery_pipeline_gate import (
    CrossVenueArbitrageDiscoveryPipelineGate,
)
...
if "CrossVenueArbitrageDiscoveryPipelineGate" not in existing_init:
    INIT_FILE.write_text(existing_init.rstrip() + "\n" + INIT_EXPORT.lstrip(), encoding="utf-8")

print("========================================")
print(" ADM-004 INSTALLER")
print(" Cross-Venue Arbitrage Discovery Pipeline Gate")
print("========================================")
print(f"[OK] Wrote {GATE_FILE}")
print(f"[OK] Wrote {TEST_FILE}")
print(f"[OK] Updated {INIT_FILE}")
print()
print("[DONE] ADM-004 installed")
print()
print("Run:")
print("py test_adm_004_cross_venue_arbitrage_discovery_pipeline_gate.py")